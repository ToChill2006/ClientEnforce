        ...
        <section className="border-b border-zinc-200 bg-white">
          <PageContainer>
            <article className="py-12 sm:py-16">
              <div className="text-xs font-semibold uppercase tracking-wider text-zinc-600">Client onboarding strategy</div>
              ...
              <div className="mt-6 rounded-2xl border border-zinc-200 bg-zinc-50 p-5">
                ...
                <ul className="mt-3 space-y-2 text-sm leading-6 text-zinc-800">
                  <li className="flex gap-2.5"><span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-zinc-900" />Onboarding fails when teams rely on reminders and memory instead of enforced steps.</li>
                  <li className="flex gap-2.5"><span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-zinc-900" />Most delays come from missing visibility, unclear ownership, and vague completion definitions.</li>
                  <li className="flex gap-2.5"><span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-zinc-900" />Automating the right parts of onboarding reduces manual follow-up and kickoff risk fast.</li>
                  <li className="flex gap-2.5"><span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-zinc-900" />Purpose-built <Link href="/client-onboarding-software" className="font-medium text-zinc-900 underline underline-offset-4">client onboarding software</Link> makes completion enforceable.</li>
                </ul>
              </div>
          ...
          <PageContainer>
            <article className="space-y-6 py-10 sm:py-12">
              <section className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
                <h2 className="text-2xl font-semibold tracking-tight text-zinc-900">1. No single place for clients to complete everything</h2>
                ...
                <p className="mt-3 text-sm leading-7 text-zinc-700 sm:text-base">
                  Fix: move onboarding into one portal with one checklist and one source of truth. If you need a starting point, use a structured <Link href="/client-onboarding-checklist" className="font-medium text-zinc-900 underline underline-offset-4">client onboarding checklist</Link> so every required item is visible before kickoff.
                </p>
              </section>

              <section className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
                <h2 className="text-2xl font-semibold tracking-tight text-zinc-900">2. Requirements are communicated over email, not enforced in a system</h2>
                <p className="mt-3 text-sm leading-7 text-zinc-700 sm:text-base">
                ...
                <p className="mt-3 text-sm leading-7 text-zinc-700 sm:text-base">
                  Fix: convert requirements into enforceable workflow steps. Use <Link href="/client-onboarding-automation" className="font-medium text-zinc-900 underline underline-offset-4">client onboarding automation</Link> rules to prevent silent misses.
                </p>
              </section>

              <section className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
                <h2 className="text-2xl font-semibold tracking-tight text-zinc-900">3. Manual follow-up depends on an individual, not a process</h2>
                <p className="mt-3 text-sm leading-7 text-zinc-700 sm:text-base">
                ...
                <p className="mt-3 text-sm leading-7 text-zinc-700 sm:text-base">
                  Fix: automate overdue nudges, receipt confirmations, and readiness alerts so quality does not depend on memory. This is where dedicated <Link href="/client-onboarding-tools" className="font-medium text-zinc-900 underline underline-offset-4">client onboarding tools</Link> beat manual coordination.
                </p>
              </section>

              <section className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
                <h2 className="text-2xl font-semibold tracking-tight text-zinc-900">4. No visibility across multiple onboardings simultaneously</h2>
                <p className="mt-3 text-sm leading-7 text-zinc-700 sm:text-base">
              ...
              <section className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
                <h2 className="text-2xl font-semibold tracking-tight text-zinc-900">5. Unclear ownership means nobody knows who is responsible</h2>
                <p className="mt-3 text-sm leading-7 text-zinc-700 sm:text-base">
              ...
              <section className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
                <h2 className="text-2xl font-semibold tracking-tight text-zinc-900">6. Onboarding is treated as admin, not as client experience</h2>
                <p className="mt-3 text-sm leading-7 text-zinc-700 sm:text-base">
              ...
              <section className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
                <h2 className="text-2xl font-semibold tracking-tight text-zinc-900">7. There is no definition of complete, so kickoff happens too early</h2>
                <p className="mt-3 text-sm leading-7 text-zinc-700 sm:text-base">
              ...
              <section className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
                <h2 className="text-2xl font-semibold tracking-tight text-zinc-900">Summary table: root causes and fixes</h2>
                  ...
                  <table className="w-full min-w-[760px] bg-white text-left text-sm text-zinc-700">
                    <thead>
                      <tr className="bg-zinc-50 text-zinc-900">
                        <th className="border-b border-zinc-200 px-4 py-3 font-semibold">Root cause</th>
                        <th className="border-b border-zinc-200 px-4 py-3 font-semibold">Fix</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                ...
                <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                  ...
                  <Link href="/blog/client-onboarding-checklist-template" className="rounded-xl border border-zinc-200 bg-zinc-50 p-4 text-sm font-semibold text-zinc-900 hover:bg-white">client onboarding checklist template</Link>
              ...
              <section className="rounded-3xl border border-zinc-200 bg-zinc-900 p-6 text-white shadow-sm sm:p-8">
                <h2 className="text-2xl font-semibold tracking-tight">Ready to fix your onboarding?</h2>
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  ...
                  <Link href="/blog/client-onboarding-checklist-template" className="inline-flex items-center justify-center rounded-xl border border-zinc-700 bg-zinc-800 px-5 py-3 text-sm font-medium text-white hover:bg-zinc-700">Read the checklist template guide</Link>
                </div>
              </section>
            </article>
          </PageContainer>
